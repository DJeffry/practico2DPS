...
const playlistId1 = "PLVxekAJ0cMoDBd4B4iLQUEvm_p1EHu4HJ";
const playlistId2 = "PLVxekAJ0cMoDOxGWmR9zd4g3J-nxMqT37";
const playlistId3 = "PLVxekAJ0cMoD3xVl2J4awppurfTGcYYEP";
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <ScrollView scrollEventThrottle={16} style={{ flex: 1 }}>
        ...
        <View style={{ backgroundColor: "black", paddingHorizontal: 20 }}>
          <Text style={styles.title}>Romanticas</Text>
